...
class _FoodState extends State<Food> {
  ...
  final List<String> _FoodServices = [
    'Cooking',
    'Dishwashing',
    'Gas Installation',
    'Chopping',
                            ...
                            Center(
                              child: ElevatedButton.icon(
                                onPressed: () {
                                  ...
                                  Navigator.pushNamed(context, '/FoodService');
                                },
...
// Code for choose Food page no. 18 in wireframe
//
//
//
...
class FoodService extends StatefulWidget {
  @override
  _FoodServiceState createState() => _FoodServiceState();
}
...
class _FoodServiceState extends State<FoodService> {
  ...
  final List<double> FoodRatings = [4.5, 3.8, 4.2, 4.9];

  TextEditingController searchController = TextEditingController();
  List<String> filteredFoodNames = [];
  ...
  void initState() {
    ...
    searchController.addListener(() {
      setState(() {
        ...
        filteredFoodNames = FoodNames.where((FoodName) =>
            FoodName.toLowerCase().contains(query.toLowerCase())).toList();
      });
    });
  }

  Future<void> _bookNow(BuildContext context, String FoodName) async {
    // TODO: Implement the "Book Now" functionality
    await Future.delayed(Duration(seconds: 2)); // Simulate a delay
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Your booking is successfully $FoodName'),
      ),
    );
  }
              ...
              child: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  return GridView.builder(
                    ...
                    itemCount: filteredFoodNames.length,
                          ...
                          child: Center(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(height: 8.0),
                                RatingBar.builder(
                                  initialRating: FoodRatings[index],
                                  minRating: 1,
                                ...
                                ElevatedButton(
                                  onPressed: () {
                                    _bookNow(context, FoodNames[index]);

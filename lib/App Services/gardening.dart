...
class _GardeningState extends State<Gardening> {
  ...
  final _booking = GardeningBooking();
  ...
  final List<String> _GardeningServices = [
    'Watering Plants',
    'Cutting',
    'Planting',
    'pluging plants',
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              items: _GardeningServices.map((service) {
                            ...
                            if (_showCustomService)
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText: 'Custom Gardening Service',
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(15),
                                    borderSide:
                                        BorderSide(color: Colors.purple),
...
// Code for choose Gardening page no. 18 in wireframe
//
//
//
...
class GardeningService extends StatefulWidget {
  @override
  _GardeningServiceState createState() => _GardeningServiceState();
}

class _GardeningServiceState extends State<GardeningService> {
  final List<String> GardeningNames = [
    'John Smith',
    'Jane Doe',
    'Bob Johnson',
    'Sara Williams'
  ...
  final List<String> GardeningPhotos = [
  ...
  final List<double> GardeningRatings = [4.5, 3.8, 4.2, 4.9];

  TextEditingController searchController = TextEditingController();
  List<String> filteredGardeningNames = [];

  @override
  void initState() {
    super.initState();
    filteredGardeningNames = GardeningNames;
    searchController.addListener(() {
      setState(() {
        String query = searchController.text;
        filteredGardeningNames = GardeningNames.where((GardeningName) =>
            GardeningName.toLowerCase().contains(query.toLowerCase())).toList();
      });
    });
  }

  Future<void> _bookNow(BuildContext context, String GardeningName) async {
    // TODO: Implement the "Book Now" functionality
    await Future.delayed(Duration(seconds: 2)); // Simulate a delay
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Your booking is successfully $GardeningName'),
      ),
    );
  }
              ...
              child: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  return GridView.builder(
                    ...
                    itemCount: filteredGardeningNames.length,
                          ...
                          child: Center(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(height: 8.0),
                                RatingBar.builder(
                                  initialRating: GardeningRatings[index],
                                  minRating: 1,
                                ...
                                ElevatedButton(
                                  onPressed: () {
                                    _bookNow(context, GardeningNames[index]);
